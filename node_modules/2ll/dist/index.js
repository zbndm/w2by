...
// node_modules/twind/sheets/sheets.js
var STYLE_ELEMENT_ID2 = "__twind";
var createStorage = () => {
  const callbacks = [];
  let state = [];
...
var getStyleTagProperties = (sheet2) => ({
  id: STYLE_ELEMENT_ID2,
  textContent: (Array.isArray(sheet2) ? sheet2 : sheet2.target).join("")
});
var getStyleTag = (sheet2, attributes) => {
  const { id, textContent } = getStyleTagProperties(sheet2);
...
var onRequest = [
  async ({ next, pluginArgs = {} }) => {
    ...
    await new HTMLRewriter().on("*", new StyleExtractor(tw2)).transform(response.clone()).text();
    return new HTMLRewriter().on("head", new StyleInjector(getStyleTag(sheet))).transform(response);
  }
];
var StyleExtractor = class {
  tw;
  constructor(tw2) {
    this.tw = tw2;
  }
...
// C:/Users/User/AppData/Local/Temp/functionsRoutes-0.20998886107420334.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
...
// C:/Users/User/AppData/Local/Yarn/Data/global/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i2 = 0;
  while (i2 < str.length) {
...
function tokensToRegexp(tokens, keys, options) {
  ...
  var _a = options.strict, strict2 = _a === void 0 ? false : _a, _b = options.start, start = _b === void 0 ? true : _b, _c = options.end, end = _c === void 0 ? true : _c, _d = options.encode, encode = _d === void 0 ? function(x) {
    return x;
...
// C:/Users/User/AppData/Local/Yarn/Data/global/node_modules/wrangler/templates/pages-template-plugin.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
